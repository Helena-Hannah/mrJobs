   ...
   <!--  <div class="row">--->
        <div class="login-box">
            <div id="login-logo" style="text-align: center">
                <img src="<?php echo base_url() ?>assets/img/fetch_logo.png" alt="fetch" style="width:95px;height: 95px;object-fit: contain;margin-top: 60px; text-align: center"/>
            </div>
            <div class="col-md-12">
...
<script src="<?php echo base_url() ?>project_scripts/CategoryScripts.js"></script>
<script src="<?php echo base_url() ?>project_scripts/ProductScripts.js"></script>
<script src="<?php echo base_url() ?>project_scripts/DiscountScripts.js"></script>
<script src="<?php echo base_url() ?>project_scripts/LocationScripts.js"></script>
